...
public class AutomovelLigeiro extends Automovel {
    ...
    public AutomovelLigeiro(String matricula, String marca, String modelo, int potenciaCv, int numeroDoQuadro,
    ...
    public String toString() {
        return "AutomovelLigeiro{" + "matricula=" + getMatricula() + ", marca=" + getMarca() + ", modelo=" + getModelo()
                + ", potenciaCv=" + getPotenciaCv() + ", numeroDoQuadro=" + getNumeroDoQuadro()
                + ", capacidadeDaBagageira=" + capacidadeDaBagageira + '}';
    }
