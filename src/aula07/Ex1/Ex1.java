...
public class Ex1 {
	public static void main(String[] args) {
		...
		ArrayList<Retangulo> rectangles = new ArrayList<Retangulo>();
		...
		do {
			...
			switch (input) {
				case 1:
					...
					String circleColour = Util.getString("Introduza uma cor: ", sc);
					Circulo newCircle = new Circulo(radius, circleColour);
				...
				case 2:
					...
					String rectColour = Util.getString("Introduza uma cor: ", sc);
					Retangulo newRectangle = new Retangulo(width, height, rectColour);
				...
				case 3:
					...
					String triangleColour = Util.getString("Introduza uma cor: ", sc);
					Triangulo newTriangle = new Triangulo(side1, side2, side3, triangleColour);
